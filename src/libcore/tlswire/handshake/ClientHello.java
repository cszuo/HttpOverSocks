...
public class ClientHello extends HandshakeMessage {
	...
	public void parseBody(DataInput in) throws IOException {
	...
	public String toString() {
		 ...
		 * + new BigInteger(1, random).toString(16) + ", sessionId: " + new
		 * BigInteger(1, sessionId).toString(16) + ", cipher suites: " +
		 * cipherSuites + ", compression methods: " + compressionMethods +
